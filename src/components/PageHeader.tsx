...
interface PageHeaderProps {
  ...
  description?: string;
  icon?: LucideIcon;
  iconClassName?: string; // Adicionada esta linha
    ...
    <div className="mb-6 sm:mb-8">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4">
        <div className="flex items-center gap-3 min-w-0"> {/* Adicionado min-w-0 */}
          {Icon && <Icon className={cn("h-7 w-7 sm:h-8 sm:w-8 text-primary hidden sm:block flex-shrink-0", iconClassName)} />} {/* Adicionado flex-shrink-0 e cn() */}
          <div className="min-w-0"> {/* Adicionado min-w-0 aqui também para o bloco de texto */}
